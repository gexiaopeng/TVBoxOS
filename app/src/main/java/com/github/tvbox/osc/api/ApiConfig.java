...
public class ApiConfig {
    ...
    public void loadConfig(boolean useCache, LoadConfigCallback callback, Activity activity) {
        String apiUrl = Hawk.get(HawkConfig.API_URL, "https://gitee.com/ge-xiaopeng/mytest/raw/master/box/m.json");
        if (apiUrl.isEmpty()) {
            callback.error("-1");
            return;
        }
...
//                System.out.println("url :"+url);
    ...
    public void loadLives(JsonArray livesArray) {
        ...
        for (JsonElement groupElement : livesArray) {
            ...
            if(gName==null || gName.length()==0 || gName.indexOf("应用多多")!=-1  || gName.indexOf("付费")!=-1  || gName.indexOf("免费")!=-1 || gName.indexOf("严禁")!=-1  || gName.indexOf("盗版")!=-1  || gName.indexOf("永久")!=-1 || gName.indexOf("公众号")!=-1 || gName.indexOf("说明")!=-1 || gName.indexOf("声明")!=-1 || gName.indexOf("维护")!=-1){
